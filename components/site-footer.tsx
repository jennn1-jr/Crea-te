    ...
    <footer className="border-t border-border bg-card/40">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          {/* Brand */}
          <div>
            <Link href="#home" className="inline-flex items-center gap-2" aria-label="Crea'Te home">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Aksesori handmade eksklusif dari limbah kain perca dengan custom art. Upcycling dengan sentuhan tangan dan kreativitas.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-2">
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-border text-muted-foreground transition-colors hover:border-primary/60 hover:bg-primary/10 hover:text-primary"
              >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-border pt-6 sm:flex-row">
          <p className="font-mono text-xs text-muted-foreground">
            © {year} Crea&apos;Te. Semua hak dilindungi.
          </p>
          <p className="text-xs text-muted-foreground">
            Dibuat dengan <span className="text-primary">♥</span> oleh Tim PMW Crea&apos;Te | Universitas Negeri Surabaya.
          </p>
        </div>
      </div>
    </footer>
